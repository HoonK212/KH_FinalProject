				...
				<div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
					<div>
						...
						<div class="text-gray-600 mb-8">
							사용자가 입력한 이메일 주소로 메일을 전송했습니다. 등록한 메일함에서 회원가입을 완료해주세요. 감사합니다.
						</div>
					</div>
				</div>
			</div>
						...
						<div class="mb-5">
							...
							<div class="flex items-center mt-4 h-3">
								<div class="w-2/3 flex justify-between h-2">	
									<div :class="{ 'bg-red-400': passwordStrengthText == '보안수준 : 취약' ||  passwordStrengthText == '보안수준 : 평범' || passwordStrengthText == '보안수준 : 강력' }" class="h-2 rounded-full mr-1 w-1/3 bg-gray-300"></div>
									<div :class="{ 'bg-orange-400': passwordStrengthText == '보안수준 : 평범' || passwordStrengthText == '보안수준 : 강력' }" class="h-2 rounded-full mr-1 w-1/3 bg-gray-300"></div>
									<div :class="{ 'bg-green-400': passwordStrengthText == '보안수준 : 강력' }" class="h-2 rounded-full w-1/3 bg-gray-300"></div>
								</div>
