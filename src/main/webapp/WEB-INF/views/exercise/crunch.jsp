				...
				<div class="flex flex-col justify-center m-auto">
					<div class="flex flex-col bg-teal-200 justify-center text-center">
						<div class="flex flex-col justify-center items-center relative">
							...
							<img alt="step1" class="w-56 h-56 shadow my-5 object-scale-down" src="<%=request.getContextPath() %>/resources/image/exercise/Crunch1-1.png">
							<div class="w-56 h-12 hidden justify-center">
						...
						<div class="ml-5 p-10 flex flex-col justify-center max-w-2xl rounded bg-teal-200">
							...
							<div class="text-xl font-bold text-teal-700">손은 머리 뒤로 가져간상태에서 천장을 보고 눕는다.</div>
						</div>
					</div>
					...
					<div class="flex flex-col bg-orange-200 justify-center text-center">
						<div class="flex flex-col justify-center items-center relative">
							...
							<img alt="step2" class="w-56 h-56 shadow my-5 object-scale-down" src="<%=request.getContextPath() %>/resources/image/exercise/Crunch1-2.png">
							<div class="w-56 h-12 hidden justify-center">
								<div class="h-full border-r-4 border-orange-300 border-dashed"></div>
							</div>
						</div>
						<div class="ml-5 p-10 flex flex-col justify-center max-w-2xl rounded bg-orange-200">
							...
							<div class="text-xl font-bold text-orange-700">바닥에서 어깨가 살짝 떨어질 정도로만 왼쪽으로 상체를 일으켜 세우면서 호흡을 내쉰다.</div>
						</div>
					</div>
					...
					<div class="flex flex-col bg-indigo-200 justify-center text-center">
						<div class="flex flex-col justify-center items-center relative">
							...
							<img alt="step3" class="w-56 h-56 shadow my-5 object-scale-down" src="<%=request.getContextPath() %>/resources/image/exercise/Crunch1-3.png">
							<div class="w-56 h-12 hidden justify-center">
								<div class="h-full border-r-4 border-indigo-300 border-dashed"></div>
							</div>
						</div>
						<div class="ml-5 p-10 flex flex-col justify-center max-w-2xl rounded bg-indigo-200">
							...
							<div class="text-xl font-bold text-indigo-700">바닥에서 어깨가 살짝 떨어질 정도로만 오른쪽으로 상체를 일으켜 세우면서 호흡을 내쉰다.</div>
						</div>
					</div>
