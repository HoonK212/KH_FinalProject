...
<section style="min-height:73vh;">
	...
	<div class="plank fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster">
		<div
			class="border border-blue-600 shadow-lg modal-container bg-white w-11/12 md:max-w-xl mx-auto rounded shadow-lg z-50 overflow-y-auto">
	...
	<div id="wrap">
		...
		<h1 class="level-title font-bold">운동을 선택해주세요</h1>
		...
		<form class="form-exercies cf" action="<%=request.getContextPath() %>/exercise/trainning" method="post">
			...
			<div class="flex nav-button margin-topbottom">
			    <button type="button" class="border border-gray-500 text-white block rounded-sm font-bold py-4 px-6 mr-2 flex items-center hover:bg-blue-600 hover:text-white bg-blue-500">
