				...
				<div class="flex flex-col justify-center m-auto">
					<div class="flex flex-col bg-teal-200 justify-center text-center">
						<div class="flex flex-col justify-center items-center relative">
							...
							<img alt="step1" class="w-56 h-56 shadow my-5 object-scale-down"  src="<%=request.getContextPath() %>/resources/image/exercise/Leg-Raise1-2.png">
							<div class="w-56 h-12 hidden justify-center">
						...
						<div class="ml-5 p-10 flex flex-col justify-center max-w-2xl rounded bg-teal-200">
							...
							<div class="text-xl font-bold text-teal-700">누워서 몸통과 다리가 직각이 되도록 자세를 취한다.</div>
						</div>
					</div>
					...
					<div class="flex flex-col bg-orange-200 justify-center text-center">
						<div class="flex flex-col justify-center items-center relative">
							...
							<img alt="step2" class="w-56 h-56 shadow my-5 object-scale-down" src="<%=request.getContextPath() %>/resources/image/exercise/Leg-Raise1-1.png">
							<div class="w-56 h-12 hidden justify-center">
								<div class="h-full border-r-4 border-orange-300 border-dashed"></div>
							</div>
						</div>
						<div class="ml-5 p-10 flex flex-col justify-center max-w-2xl rounded bg-orange-200">
							...
							<div class="text-xl font-bold text-orange-700">다리를 들어올렸다면 숨을 들이마셔 복부에 공기를 채운다는 느낌으로 배에 힘을 줍니다.</div>
						</div>
					</div>
					...
					<div class="flex flex-col bg-indigo-200 justify-center text-center">
						<div class="flex flex-col justify-center items-center relative">
							...
							<img alt="step3" class="w-56 h-56 shadow my-5 object-scale-down" src="<%=request.getContextPath() %>/resources/image/exercise/Leg-Raise1-2.png">
							<div class="w-56 h-12 hidden justify-center">
								<div class="h-full border-r-4 border-indigo-300 border-dashed"></div>
							</div>
						</div>
						<div class="ml-5 p-10 flex flex-col justify-center max-w-2xl rounded bg-indigo-200">
							...
							<div class="text-xl font-bold text-indigo-700">다시 몸통과 같이 직각이 되도록 다리를 들어올립니다.</div>
						</div>
					</div>
...
<!-- 								<button type="button" onclick="init()">Start</button> -->
								...
								<script type="text/javascript">
								    ...
								    const URL = "<%=request.getContextPath() %>/resources/motionmodel/legraise/";
