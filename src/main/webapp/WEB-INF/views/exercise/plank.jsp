...
<!-- 									<button type="button" onclick="init()">운동 Start</button> -->
			...
			<div class="mt-8 border border-blue-800 mx-8 lg:mx-16 flex flex-wrap">
				...
				<a href="<%=request.getContextPath()%>/exercise/exercisefinish"href="<%=request.getContextPath()%>/exercise/exercisefinish" class="block flex items-center justify-center bg-blue-800 hover:bg-blue-700 p-4 text-md font-semibold text-gray-300 uppercase mt-8 complete">
