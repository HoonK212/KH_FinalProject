...
<div class="md:flex md:items-center">
                ...
                <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                    <h3 class="text-gray-700 uppercase text-lg">${detail.name }</h3>
                    <span class="text-gray-500 mt-3">${detail.price }</span>
                    <hr class="my-3">
                    <div class="mt-2">
                    ...
                    <div class="flex items-center mt-6">
                        <button onclick="location.href='<%=request.getContextPath()%>/shopping/payment?codes=${detail.code}&userId=${logInInfo.id }'" class="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">주문하기</button>
