...
<link rel="stylesheet"  href="<%=request.getContextPath() %>/resources/css/myInformation.css" />
...
<table class="table table-action">
  ...
  <tbody>
    <tr>
      <td><img alt="#" src="<%=request.getContextPath() %>/resources/image/Plank.jpg" style="width:200;"></td>
      <td>
	      <span class="button raised green center" style="width:57; height:35; line-height:35px;">사진등록</span>
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td> <span class="button raised green center" style="width:57; height:35; line-height:35px;">수정</span></td>
