...
<aside class="side-nav" id="show-side-navigation1">
  ...
  <div class="search">
    <input type="text" placeholder="메인으로 " readonly><i class="fa fa-search"></i>
  </div>
  <ul class="categories">
...
<table class="table table-action">
  ...
  <tbody>
    <tr>
     ...
     <img src="<%=request.getContextPath()%>/resources/${file.path}/${file.renamed }.${file.ext}" id="imagePreview" alt="Preview Image" style="width:200px; height:180px;"/>
      </td> 
      <td>
