...
<%@include file="/WEB-INF/views/mypage/navi.jsp" %>
 ...
 <div style="padding-left: 350px; padding-top: 100px; display:grid; grid-template-columns: 300px 300px 400px; grid-template-rows: 300px 400px; gap:20px; " >	
 ...
 <div style="grid-column: 3/4; grid-row: 1/2;">	
	  ...
	  <div class="flex bg-teal-400 max-w-sm mb-4">
	  	...
	  	<div class="flex bg-yellow-400 max-w-sm mb-4">
...
<div div style="grid-column: 1/4; grid-row: 2/3;">  
	 <div id="calendar"></div>
</div>
