...
<div class="lay-item">
	...
	<div class="section-container">
		...
		<!-- 상단 제목 영역 -->
		<span class="font-semibold text-4xl">재고목록</span>
			  ...
			  <div class="shadow overflow-hidden rounded border-b border-gray-200">
			    <table class="table-fixed bg-white w-full">
			      <thead class="bg-gray-800 text-white">
			        <tr>
			          <th class="w-1/4 py-3 px-4 uppercase font-semibold text-sm">상품번호</th>
			          ...
			          <th class="w-1/4 py-3 px-4 uppercase font-semibold text-sm">판매중단</td>
			        </tr>
			      </thead>
			    <tbody class="text-gray-700">
			      <tr>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">A1002</a></td>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">닭가슴살</a></td>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">300</a></td>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">N</a></td>
			      </tr>
			      <tr class="bg-gray-100">
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">A1003</a></td>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">샐러드</a></td>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">500</a></td>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500" >N</a></td>
			      </tr>
			      <tr>
			        <td class="w-1/4 py-3 px-4 text-center"><a class="hover:text-blue-500">A1002</a></td>
